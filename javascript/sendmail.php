...
$sendto = 'tim@trilogyincar.com, timdoyle73@gmail.com, wearemechanised@gmail.com';
...
//This is for javascript,
		echo "<script>$(\".message\").hide(\"slow\").show(\"slow\").animate({opacity: 1.0}, 750).hide(\"slow\"); $(':input').clearForm() </script>";
		echo $thanks;
